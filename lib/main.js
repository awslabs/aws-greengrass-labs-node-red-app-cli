    ...
    const tasks = new listr2_1.Listr([
        ...
        },
        {
            ...
            task: async (ctx) => {
                ...
                const nodeArchiveTempPath = await (0, utils_1.createNodeModulesArchive)(config.dataFolder);
        ...
        },
        {
            ...
            task: async () => {
                ...
                fs.mkdirSync(artifactPath, { recursive: true });
                const flowsTempPath = await (0, utils_1.createFlowsArchive)(config.dataFolder);
